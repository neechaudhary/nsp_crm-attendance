  ...
  return (
    <div>
        <div className='flex justify-around my-[10px]'>
            <div></div>
            <div className='text-[25px] font-bold'>USER LOGIN</div>
            <Link to='/admin-login'>
            <div className='w-[100px] cursor-pointer bg-red-200 flex items-center justify-center text-[18px] font-semibold'>Admin</div>
            </Link>
        </div>
                    ...
                    <div class="p-5 bg-white md:flex-1">
                        ...
                        <div action="#" class="flex flex-col space-y-5">
                            <div class="flex flex-col space-y-1">
                                <label for="email" class="text-sm font-semibold text-gray-500">Userid</label>
                                <input
                                    type="email"
                                    id="email"
                                    autofocus
