...
const Project = () => {
  ...
  return (
    <div>
         <Menu>
                <div className='container_for_ongoing_pending_completed pt-[10px]'>
                    <div className='container_for_ongoing mt-[10px]'>
                        <div className='flex  justify-between border-b-2 py-[5px]'>
                            <div className='flex'>
                                <div className='ongoing_icon bg-[#4674D6]  flex justify-center items-center w-[30px] rounded-md'><GiProgression className='text-white' /></div>
                    ...
                    <div className='container_for_completed'>
                    <div className='container_for_completed mt-[10px]'>
                        <div className='flex  justify-between border-b-2 py-[5px]'>
                            <div className='flex'>
                                <div className='ongoing_icon bg-[#4674D6]  flex justify-center items-center w-[30px] rounded-md'><IoMdDoneAll className='text-white' size={20}/></div>
                                <div className='flex items-center ml-[10px] font-semibold text-[16px]'><h1>Completed Projects</h1></div>
                            </div>
                            <div className='flex items-center'>
                                <button className='bg-[#4674D6] text-white px-[10px] py-[5px] rounded-md hover:bg-[#ffffff] hover:text-[#c726c7]'>View all</button>
                            </div>
